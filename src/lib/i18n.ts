...
export const messages: Dict = {
  ...
  "product.retail": { en: "Retail", ar: "ثمن التقسيط", fr: "Détail" },
  "product.wholesale": { en: "Wholesale", ar: "ثمن الجملة", fr: "Gros" },
  "product.perItem": { en: "/item", ar: "/قطعة", fr: "/article" },
  "product.wholesaleFrom": { en: "for {min}+ pcs", ar: "ابتداءً من {min} قطعة", fr: "pour {min}+ pcs" },
  ...
  "cart.shipping": { en: "Shipping", ar: "التوصيل", fr: "Livraison" },
  "cart.shippingAtCheckout": {
    en: "Calculated at checkout",
    ar: "يُحتسب عند الدفع",
    fr: "Calculé au paiement",
  },
  "cart.wholesaleApplied": {
    en: "Wholesale price applied",
    ar: "تم تطبيق ثمن الجملة",
    fr: "Prix de gros appliqué",
  },
  ...
  "admin.finances": { en: "Finances & Wallet", ar: "المالية والمحفظة", fr: "Finances & portefeuille" },
  "admin.shipping": { en: "Shipping & Delivery", ar: "الشحن والتوصيل", fr: "Livraison" },
  ...
  "invoice.shipping": { en: "Shipping", ar: "التوصيل", fr: "Livraison" },
